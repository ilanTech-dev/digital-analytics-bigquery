-- User-level eCommerce funnel step-reach model.
-- Grain: date, dimensions, user and funnel step.

CREATE OR REPLACE TABLE `your-gcp-project.analytics_portfolio.mart_user_step_reach` AS
...
SELECT DISTINCT
  event_date, week_start, country, device_category, operating_system,
  new_returning_user, user_pseudo_id, step.step_order, step.funnel_step
